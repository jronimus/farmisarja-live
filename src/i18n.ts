...
const copy = {
  ...
  en: {
    ...
    gameAverage: "game average over the same gameweeks", formNote: "LAST 5 GW", formVersus: "vs. game average over the same gameweeks:", feed: "EVENTS", feedWaiting: "Waiting for events…", feedAll: "All events", feedHideLowImpact: "Hide low impact", feedOnlyOurs: "Only our players",
