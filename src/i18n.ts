...
const copy = {
    ...
    gwPoints: "GW-pisteet", total: "Yhteensä", captain: "Kapteeni", transfers: "Siirrot", seasonTransfers: "Siirrot yhteensä", chips: "Chips", teamValue: "Arvo", benchPoints: "Penkki", progress: "Tilanne",
    ...
    rankEstimate: "Arvioitu live-yleissija", dataPreview: "GW1-data ei ole vielä avautunut — näkymässä on esikatseludata", transfer: "siirto", transfersCount: "siirtoa", nextGw: "Seuraava GW", net: "netto", oldTeam: "Vanha", currentTeam: "Nykyinen",
  },
  en: {
    live: "LIVE", preview: "PREVIEW", updated: "Updated", position: "Pos", manager: "Team / manager",
    gwPoints: "GW points", total: "Total", captain: "Captain", transfers: "Transfers", seasonTransfers: "Total transfers", chips: "Chips", teamValue: "Value", benchPoints: "Bench", progress: "Progress",
    ...
    rankEstimate: "Estimated live overall rank", dataPreview: "GW1 data is not available yet — showing preview data", transfer: "transfer", transfersCount: "transfers", nextGw: "Next GW", net: "net", oldTeam: "Previous", currentTeam: "Current",
  },
} as const;
