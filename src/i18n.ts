...
const copy = {
    ...
    gameAverage: "kaikkien keskiarvo samoilta kierroksilta", feed: "TAPAHTUMAT", feedWaiting: "Odotetaan tapahtumia…", feedAll: "Kaikki tapahtumat", feedHideLowImpact: "Piilota pikkujutut", feedOnlyOurs: "Vain meidän pelaajat",
  ...
  en: {
    ...
    gameAverage: "game average over the same gameweeks", feed: "EVENTS", feedWaiting: "Waiting for events…", feedAll: "All events", feedHideLowImpact: "Hide low impact", feedOnlyOurs: "Only our players",
