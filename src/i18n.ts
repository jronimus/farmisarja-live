...
const copy = {
    ...
    highlightPlayer: "Korosta pelaaja", allPlayers: "Ei korostusta", inSquads: "joukkueessa", asCaptain: "kapteenina", onBench: "penkillä", effectiveOwnership: "Tehollinen omistus", startersOnly: "Vain avaus", lastFive: "Viisi viimeistä",
  ...
  en: {
    ...
    highlightPlayer: "Highlight player", allPlayers: "No highlight", inSquads: "squads", asCaptain: "as captain", onBench: "benched", effectiveOwnership: "Effective ownership", startersOnly: "Starting XI only", lastFive: "Last five",
