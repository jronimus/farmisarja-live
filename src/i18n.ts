...
const copy = {
    ...
    ownership: "Omistus", price: "Hinta", willRise: "Nousee", willFall: "Laskee", outlookToday: "tänään", outlookTomorrow: "huomenna", outlookTwoDays: "ylihuomenna", outlookInDays: "{n} päivän päästä", mayRiseThisWeek: "Saattaa nousta tällä viikolla", mayFallThisWeek: "Saattaa laskea tällä viikolla", unlikelyThisWeek: "Tuskin tällä viikolla",
  ...
  en: {
    ...
    ownership: "Ownership", price: "Price", willRise: "Rises", willFall: "Falls", outlookToday: "today", outlookTomorrow: "tomorrow", outlookTwoDays: "in 2 days", outlookInDays: "in {n} days", mayRiseThisWeek: "May rise this week", mayFallThisWeek: "May fall this week", unlikelyThisWeek: "Unlikely this week",
