...
const copy = {
    ...
    highlightPlayer: "Korosta pelaaja", allPlayers: "Ei korostusta", inSquads: "joukkueessa", asCaptain: "kapteenina", onBench: "penkillä", effectiveOwnership: "Tehollinen omistus",
  ...
  en: {
    ...
    highlightPlayer: "Highlight player", allPlayers: "No highlight", inSquads: "squads", asCaptain: "as captain", onBench: "benched", effectiveOwnership: "Effective ownership",
